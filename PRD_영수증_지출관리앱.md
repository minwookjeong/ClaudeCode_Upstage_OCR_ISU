...
| 스타일링 | TailwindCSS | v3+ |
| HTTP 클라이언트 | Axios | v1+ |
| 백엔드 | Python FastAPI | v0.135.3 |
| LLM 오케스트레이션 | LangChain | v1.2.15 |
| LLM 코어 | LangChain Core | v1.2.29 |
| LLM 에이전트 | LangGraph | v1.1.6 |
| LLM 모니터링 | LangSmith | v0.7.31 |
| OCR LLM | Upstage document-digitization-vision (langchain-upstage v0.7.7) | - |
| 이미지 처리 | Pillow v12.2.0 / pdf2image v1.17.0 | - |
